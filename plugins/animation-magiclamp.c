...
{
	const BananaValue *
	option_magic_lamp_grid_res = bananaGetOption (bananaIndex,
	                                              "magic_lamp_grid_res",
	                                              w->screen->screenNum);

	*gridWidth = 2;
	*gridHeight = option_magic_lamp_grid_res->i;
}
...
{
	const BananaValue *
	option_vacuum_grid_res = bananaGetOption (bananaIndex,
	                                          "vacuum_grid_res",
	                                          w->screen->screenNum);

	*gridWidth = 2;
	*gridHeight = option_vacuum_grid_res->i;
}
...
fxMagicLampInit (CompWindow *w)
{
	...
	const BananaValue *
	option_magic_lamp_max_waves = bananaGetOption (bananaIndex,
	                                               "magic_lamp_max_waves",
	                                               w->screen->screenNum);

	const BananaValue *
	option_magic_lamp_amp_min = bananaGetOption (bananaIndex,
	                                             "magic_lamp_amp_min",
	                                             w->screen->screenNum);

	const BananaValue *
	option_magic_lamp_amp_max = bananaGetOption (bananaIndex,
	                                             "magic_lamp_amp_max",
	                                             w->screen->screenNum);

	if (aw->com.curAnimEffect == AnimEffectMagicLamp)
	{
		maxWaves = option_magic_lamp_max_waves->i;
		waveAmpMin = option_magic_lamp_amp_min->f;
		waveAmpMax = option_magic_lamp_amp_max->f;
	}
	else
	{
		maxWaves = 0;
                      ...
                      float      time)
{
	...
	const BananaValue *
	option_magic_lamp_moving_end = bananaGetOption (bananaIndex,
	                                         "magic_lamp_moving_end",
	                                         w->screen->screenNum);

	const BananaValue *
	option_vacuum_moving_end = bananaGetOption (bananaIndex,
	                                            "vacuum_moving_end",
	                                            w->screen->screenNum);
	...
	if ((aw->com.curWindowEvent == WindowEventOpen ||
	    ...
	    ((aw->com.curAnimEffect == AnimEffectMagicLamp &&
	      option_magic_lamp_moving_end->b) ||
	     (aw->com.curAnimEffect == AnimEffectVacuum &&
	      option_vacuum_moving_end->b)))
	{
