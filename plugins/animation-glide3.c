...
fxGlide3Init (CompWindow *w)
{
	...
	const BananaValue *
	option_glide3_away_position = bananaGetOption (bananaIndex,
	                                               "glide3_away_position",
	                                               s->screenNum);

	const BananaValue *
	option_glide3_away_angle = bananaGetOption (bananaIndex,
	                                            "glide3_away_angle",
	                                            s->screenNum);

	const BananaValue *
	option_glide3_thickness = bananaGetOption (bananaIndex,
	                                           "glide3_thickness",
	                                           s->screenNum);

	float finalDistFac = option_glide3_away_position->f;
	float finalRotAng = option_glide3_away_angle->f;
	float thickness = option_glide3_thickness->f;
