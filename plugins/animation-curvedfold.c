                       ...
                       float      time)
{
	...
	const BananaValue *
	option_curved_fold_amp_mult = bananaGetOption (bananaIndex,
	                                               "curved_fold_amp_mult",
	                                               w->screen->screenNum);

	float curveMaxAmp = 0.4 * pow ((float)WIN_H (w) / w->screen->height, 0.4) *
	                    option_curved_fold_amp_mult->f;
                          ...
                          WindowPaintAttrib *wAttrib)
{
	...
	const BananaValue *
	option_curved_fold_zoom_to_taskbar = bananaGetOption (bananaIndex,
	...
	if (aw->com.curWindowEvent == WindowEventOpen ||
	    ...
	    ((aw->com.curWindowEvent == WindowEventMinimize ||
	     ...
	     ((aw->com.curAnimEffect == AnimEffectCurvedFold &&
	       !option_curved_fold_zoom_to_taskbar->b) ||
